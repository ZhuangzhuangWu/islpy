...
PYBIND11_MODULE(_isl, m)
{
  ...
  */
  ...
  py::enum_<isl_polyacc_loop_type>(m, "polyacc_loop_type")
    .ENUM_VALUE(isl_polyacc_loop_, error)
    .ENUM_VALUE(isl_polyacc_loop_, default)
    .ENUM_VALUE(isl_polyacc_loop_, time)
    .ENUM_VALUE(isl_polyacc_loop_, spatial_x)
    .ENUM_VALUE(isl_polyacc_loop_, spatial_y)
    .ENUM_VALUE(isl_polyacc_loop_, spatial_z)
    .ENUM_VALUE(isl_polyacc_loop_, latency)
    .ENUM_VALUE(isl_polyacc_loop_, simd)
    .ENUM_VALUE(isl_polyacc_loop_, array_part)
    ;
